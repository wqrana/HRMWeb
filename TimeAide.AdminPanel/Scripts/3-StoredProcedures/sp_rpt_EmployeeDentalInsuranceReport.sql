...
-- Description:	<Fetch the Employee Dental Insurance Report data>
-- =============================================
CREATE PROCEDURE [dbo].[sp_rpt_EmployeeDentalInsuranceReport] 
...
BEGIN
	...
	SELECT distinct empgrm.EmployeeId,empgrm.ShortFullName,dentalInsurance.*
	FROM [vw_rpt_EmployeeDentalInsuranceInfo] dentalInsurance
	INNER JOIN vw_rpt_EmployeeGeneralRptMain empgrm ON empgrm.UserInformationId = dentalInsurance.UserInformationId
