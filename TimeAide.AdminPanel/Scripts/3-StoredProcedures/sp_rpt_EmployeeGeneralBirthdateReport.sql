...
-- Description:	<Fetch the Employee General Report (Birthday report data>
-- =============================================
CREATE PROCEDURE [dbo].[sp_rpt_EmployeeGeneralBirthdateReport] 
...
BEGIN
	...
	AND  BirthDate BETWEEN @fromDate AND @toDate
