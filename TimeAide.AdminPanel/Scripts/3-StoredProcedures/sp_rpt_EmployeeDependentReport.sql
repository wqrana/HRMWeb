...
-- Description:	<Fetch the Employee Dependent Report data>
-- =============================================
CREATE PROCEDURE [dbo].[sp_rpt_EmployeeDependentReport] 
...
BEGIN
	...
	SELECT distinct empgrm.EmployeeId,empgrm.ShortFullName,empdpnt.*
	FROM vw_rpt_EmployeeDependentInfo empdpnt
	INNER JOIN vw_rpt_EmployeeGeneralRptMain empgrm ON empgrm.UserInformationId = empdpnt.UserInformationId
