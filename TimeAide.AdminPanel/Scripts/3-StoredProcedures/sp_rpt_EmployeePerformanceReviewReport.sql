...
-- Description:	<Fetch the Employee Performance review Report data>
-- =============================================
CREATE PROCEDURE [dbo].[sp_rpt_EmployeePerformanceReviewReport] 
...
BEGIN
	...
	SELECT distinct empgrm.EmployeeId,empgrm.ShortFullName,empPerfReview.*
	FROM vw_rpt_EmployeePerformanceReviewInfo empPerfReview
	INNER JOIN vw_rpt_EmployeeGeneralRptMain empgrm ON empgrm.UserInformationId = empPerfReview.UserInformationId
