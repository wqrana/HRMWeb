...
-- Description:	<Fetch the Employee Health Insurance Report data>
-- =============================================
CREATE PROCEDURE [dbo].[sp_rpt_EmployeeHealthInsuranceReport] 
...
BEGIN
	...
	SELECT distinct empgrm.EmployeeId,empgrm.ShortFullName,healthInsurance.*
	FROM [vw_rpt_EmployeeHealthInsuranceInfo] healthInsurance
	INNER JOIN vw_rpt_EmployeeGeneralRptMain empgrm ON empgrm.UserInformationId = healthInsurance.UserInformationId
